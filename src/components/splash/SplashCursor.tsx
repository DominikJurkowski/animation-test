...
export default function SplashCursor({
  ...
  useEffect(() => {
    ...
    function generateColor(): ColorRGB {
      // Define the color palette from the specified range
      const colors = [
        { r: 0.996, g: 0.243, b: 0.847 }, // #FE3ED8
        { r: 0.965, g: 0.761, b: 0.643 }, // #F6C2A4
        { r: 0.973, g: 0.996, b: 0.757 }, // #F8FEC1
      ];
      ...
      const c = {
        r: randomColor.r * 0.15,
        g: randomColor.g * 0.15,
        b: randomColor.b * 0.15,
      };
