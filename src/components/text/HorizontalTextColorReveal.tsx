...
interface HorizontalTextColorRevealProps {
  children: string;
  className?: string;
  duration?: number;
  stagger?: number;
...
const HorizontalTextColorReveal: React.FC<HorizontalTextColorRevealProps> = ({
  children,
  className,
  duration = 0.6,
  stagger = 0.05,
      ...
      children.split('').map((letter, index) => (
        <span
          ...
          style={{
            ...
            color: '#F1BC5C', // Start with orange color
  ...
  const animateText = useCallback(() => {
    ...
    tl.to(letterElements, {
      ...
      // Color sequence: orange → pink → black (happening simultaneously with reveal)
      .to(
        letterElements,
        {
          color: '#F1BC5C', // Orange
      ...
      .to(
        ...
        duration * 0.3 // Start after 30% of main animation
      )
      .to(
        letterElements,
        {
        ...
        duration * 0.6 // Start after 60% of main animation
      );
  }, [
    textRef,
    isAnimating,
...
export default HorizontalTextColorReveal;
